...
const faqData = [
    {
        question: 'Apa itu LuccaneXz Store?',
        answer: '<ul>LuccaneXz Store adalah penyedia layanan hosting terkemuka yang berfokus pada panel Pterodactyl untuk server game dan aplikasi. Kami menawarkan hosting berkualitas premium dengan harga terjangkau dan performa optimal.</ul>'
    },
    {
        question: 'Bagaimana cara membeli hosting di LuccaneXz Store?',
    ...
    {
        question: 'Apakah LuccaneXz Store menyediakan layanan support?',
